  ...
  <div class="container-fluid internship-section py-5">
    <div class="row align-items-center">
      ...
      <div class="col-md-6 text-center p-md-5">
        <img src="assets/images/video-player.png" 
             alt="Internships Video" 
             class="img-fluid" 
    ...
    <div class="row">
      <div class="col-12 text-center position-relative p-0">
        <img src="assets/images/paris.png" 
             alt="Paris"
             class="img-fluid"
      ...
      <div class="row g-4">
        ...
        <div class="col-md-3">
          <div class="card p-3 text-center">
            <img src="assets/images/Denmark.png" 
                 alt="Denmark flag"
        ...
        <div class="col-md-3">
          <div class="card p-3 text-center">
            <img src="assets/images/Netherlands.png" 
        ...
        <div class="col-md-3">
          <div class="card p-3 text-center">
            <img src="assets/images/Romania.png" 
                 alt="Romania flag"
                 class="img-fluid rounded-circle"
                 style="width:60px; height:60px; object-fit:cover;" />
            <div class="card-body text-start">
...
<div id="section" class="bg-white pb-5">
      <h1 class="pt-5 text-center fw-bold" style="color:#00B7F9;">Talk to Us</h1>
